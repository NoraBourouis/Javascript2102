...
let o = 0;
    journalistes.forEach(string=> {
        if (string.match(/(a|A)(u|U)(d|D)(e|E)/)) {
            o++;
        }
    });
console.log('il y a ' + o + ' handles qui contiennent les 4 lettres du prénom "Aude" .')
...
console.log('il y a ' + m + ' qui commencent par une majuscule .')
...
console.log('il y a ' + n + ' contiennent une majuscule.')

//Combien y a-t-il de underscore _ dans tous les pseudos confondus ?


let p = 0;
let journaliste = journalistes.join("");
    journaliste.split("").forEach(string=> {
        if (string.match(/_/)) {
            p++;
        }
    });
console.log('il y a ' + p + ' pseudo avec un underscore _ dans tous les pseudos confondus.')

//Quelle est la position dans l'array de la personne @epenser ?
console.log('la position du journaliste @epenser est ' + journalistes.indexOf("@epenser"))


//Trie la liste de handles par ordre alphabétique.

var sortedArray = journalistes.sort()
console.log(sortedArray);

//Quels sont les 50 handles les plus courts de cette array ?

var sortedLength = journalistes.sort(function(a, b) {
